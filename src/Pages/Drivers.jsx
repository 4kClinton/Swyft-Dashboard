...
function Drivers() {
  ...
  // Slider references using callback refs (state)
  ...
  const handleRestrict = async () => {
    ...
    try {
      ...
      // Update local state to reflect the verified status change
  ...
  // Prepare image data for the carousel including additional documents
